...
class ContratType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
            ...
            ->add('nomEnfant')
            ->add('prenomEnfant')
            ->add('dateNaissance' ,DateType::class, array('label' => 'Date de naissance de l\'enfant ' ,  'years' => range(1990 , 2030) , 'placeholder' => 'Choix d\'une date'))
            ->add('dateEffetContrat',DateType::class, array('label' => 'Date d\'effet du contrat' , 'years' => range(1990 , 2030), 'placeholder' => 'Choix d\'une date'))
            ...
            ->add('jourRepos' )
            ->add('isMensuel' , CheckboxType::class , array('label' => 'Planning mensuel s\'il y a lieu' , 'required' => false))
            ...
            ->add('datePaiementSalaire' , DateType::class , array('label' => 'Date de paiement du salaire', 'placeholder' => 'Choix d\'une date'))
            ->add('delaiPrevenanceConge' , DateType::class , array('label' => 'Péciser le délai de prévenace de fixation des dates de congés', 'placeholder' => 'Choix d\'une date'))
